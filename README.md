...
"Managing Money can be a tedious task, but it can be made easier with a computer." This product of this project will be a functioning budget manager application using Python. The emphasis of this project is to gain a deeper understanding and become more comfortable with with Python dictionaries and classes.
